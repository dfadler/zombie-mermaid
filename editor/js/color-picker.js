...
document
  .getElementById('color-popup-close')
  .addEventListener('click', closeColorPopup)

document
  .getElementById('color-clear-btn')
...
document.addEventListener('click', function (e) {
  ...
  if (!e.target.closest('#color-popup') && !e.target.closest('.color-edit-btn'))
    closeColorPopup()
})
